...
class Net(nn.Module):
    def __init__(self):
        ...
        self.avgpool0 = nn.AvgPool2d(kernel_size=3, stride=1, padding=1)

        # CONVOLUTION BLOCK 1
        self.convblock2 = nn.Sequential(
            nn.Conv2d(in_channels=10, out_channels=22, kernel_size=(3, 3), padding=2, bias=False),
            nn.LeakyReLU(0.2),
            nn.BatchNorm2d(22),
            nn.Dropout(dropout_value)
        )
        ...
        self.convblock4 = nn.Sequential(
            nn.Conv2d(in_channels=10, out_channels=22, kernel_size=(3, 3), padding=2, groups=2, bias=False),
            nn.GELU(),            
            nn.BatchNorm2d(22),
            nn.Dropout(dropout_value)
        )
        ...
        self.convblock5 = nn.Sequential(
            nn.Conv2d(in_channels=22, out_channels=22, kernel_size=(3, 3), padding=2, groups=22, bias=False),
            nn.BatchNorm2d(22),
            nn.LeakyReLU(0.2),            
            nn.Dropout(dropout_value)
        )
        ...
        self.avgpool3 = nn.AvgPool2d(kernel_size=2, stride=1, padding=1)

        self.convblock6 = nn.Sequential(
            nn.Conv2d(in_channels=22, out_channels=14, kernel_size=(3, 3), padding=2, bias=False),
            nn.GELU(),            
            nn.BatchNorm2d(14),
            nn.Dropout(dropout_value)
        )
